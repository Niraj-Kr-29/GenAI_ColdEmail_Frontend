  ...
  return (
    <div className="top-0 left-0 z-[-2] h-[45rem] w-screen bg-[#000000] bg-[radial-gradient(#ffffff33_1px,#00091d_1px)] bg-[size:20px_20px] flex justify-center">
      <div className="w-[90%] h-[80%] bg-slate-900 rounded-3xl px-10 ">
        ...
        <div className="flex gap-14 lg:gap-10 overflow-x-auto overflow-visible h-[26rem] w-full">
          {
            keyFeatures.map((feature,index)=>{
              return <div className="sm:min-w-72 h-[20rem] mt-6"><FeatureCard key={index} title={feature.title} description={feature.description}/></div>
            })
          }
        </div>
      </div>
