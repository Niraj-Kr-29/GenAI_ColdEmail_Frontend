...
const FeatureCard = ({title="Feature", description="Description"}) => {
  return (
    <div className='sm:h-[22rem] sm:w-80 lg:w-72 w-64 w-full h-full bg-slate-700 rounded-xl p-4 px-6 hover:scale-110 transition-all cursor-pointer hover:bg-slate-600'>
